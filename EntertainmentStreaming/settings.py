"""
Django settings for EntertainmentStreaming project.
...
SECRET_KEY = 'sh90642#50u3&mttj@2j#k1+y57&qo^f%u*6z+2q=s0ofs@%)a'
...
WSGI_APPLICATION = 'EntertainmentStreaming.wsgi.application'
